...
This repository contains a set of R scripts for cleaning, processing, and vectorizing AIS (Automatic Identification System) data. The workflow extracts, cleans, and processes AIS data, creating vector outputs for ship tracks. The scripts implement various preprocessing steps, including filtering invalid data, spatial transformation, and segmentation of ship tracks.
